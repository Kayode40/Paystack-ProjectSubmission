    ...
    <div class="container-fluid">
      <div class="row-fluid">
		<div class="span4">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;"><center>IBRAHIM BAKERY </center></font>
		<br>
...
<!--<button class="btn btn-large btn-primary btn-block pull-right" href="dashboard.html" type="submit"><i class="icon-signin icon-large"></i> Login</button>-->	
	...
	<br>
	<center>
	<a href="login.php" class="btn btn-primary " style="margin-top: 6px;">LOGIN</a>
