...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				include('config.php');
				$qry = "SELECT * FROM supplier WHERE delivery_status = 'Delivered' ORDER BY supplier_id DESC";
			...
			<td><a rel="facebox" href="makepayment.php?id=<?php echo $row['supplier_id']; ?>"><button class="btn btn-warning btn-mini">Pay Now </button></a>
			</tr>
			<?php
				}
			?>
